...
export function SalesmenFilter({ listLoading }) {
  // Salesmen UI Context
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(salesmenUIProps.queryParams, values);
    if (!isEqual(newQueryParams, salesmenUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      // update list by queryParams
      salesmenUIProps.setQueryParams(newQueryParams);
    }
  };
