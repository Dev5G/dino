...
import { fetchSaleInvoice } from '../Manage/_redux/sales/salesActions';
								...
								<div className="invoice-box row">
									<div className="col-sm-12">
										<table className="table table-responsive invoice-table table-borderless p-l-20">
											<tbody>
												<tr>
													<td><a href="https://clickjewelry.enzayco.cf" className="b-brand">
														<img className="img-fluid" src={toAbsoluteUrl('/media/logos/logo-dark.png')} alt="Able Pro Logo" />
													</a>
													</td>
												</tr>
												<tr>
