...
export function CountersFilter({ listLoading }) {
  // Counters UI Context
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(countersUIProps.queryParams, values);
    if (!isEqual(newQueryParams, countersUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      // update list by queryParams
      countersUIProps.setQueryParams(newQueryParams);
    }
  };
