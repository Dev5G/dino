...
const url = {
    goldrateUrl: apiUrl.BASE_URL + apiUrl.apiPath + apiUrl.version + apiUrl.goldratePath,
    goldratesUrl: apiUrl.BASE_URL + apiUrl.apiPath + apiUrl.version + apiUrl.goldratesPath,
}
...
export function updateGoldrate(goldrate) {
  return axios.put(`${CUSTOMERS_URL}/${goldrate.id}`, { goldrate });
}
